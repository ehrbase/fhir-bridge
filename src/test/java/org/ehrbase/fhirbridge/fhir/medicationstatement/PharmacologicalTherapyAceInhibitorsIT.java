...
/**
 * Integration tests for {@link MedicationStatement} using Pharmacological Therapy ACE Inhibitors profile.
 */
class PharmacologicalTherapyAceInhibitorsIT extends AbstractMappingTestSetupIT {

    public PharmacologicalTherapyAceInhibitorsIT() {
