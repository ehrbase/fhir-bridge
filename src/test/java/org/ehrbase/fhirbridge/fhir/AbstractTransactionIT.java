...
public class AbstractTransactionIT extends AbstractSetupIT {
    ...
    private String getResourceAsString(String resourceLocation) throws IOException {
        var reader = new InputStreamReader(new ClassPathResource(resourceLocation).getInputStream(), StandardCharsets.UTF_8);
        var resource = FileCopyUtils.copyToString(reader);
