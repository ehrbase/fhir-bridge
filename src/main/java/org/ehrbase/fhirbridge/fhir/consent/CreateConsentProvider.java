 ...
 * @since 1.0.0
 */
public class CreateConsentProvider extends AbstractPlainProvider {

    @Create
    public MethodOutcome createConsent(@ResourceParam Consent consent, RequestDetails requestDetails,
