 ...
 * for 'Find Composition' transaction.
 *
 * @since 1.0.0
 */
public class FindCompositionAuditStrategy extends FhirQueryAuditStrategy {

    public FindCompositionAuditStrategy() {
    ...
    public AuditMessage[] makeAuditMessage(AuditContext auditContext, FhirQueryAuditDataset auditDataset) {
        return new QueryInformationBuilder<>(auditContext, auditDataset, FhirBridgeEventType.FIND_COMPOSITION)
