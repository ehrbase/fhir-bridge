...
public class UCCAppProDatenBundleConverter extends AbstractBundleConverter<Composition> {

    @Override
    public Composition convert(@NonNull Bundle bundle) {
        Composition composition = getRoot(bundle, Profile.UCC_APP_PRO_DATEN);
