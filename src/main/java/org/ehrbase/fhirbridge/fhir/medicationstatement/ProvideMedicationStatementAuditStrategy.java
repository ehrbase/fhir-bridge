...
/**
 * Custom implementation of {@link GenericFhirAuditStrategy} for 'Provide Medication Statement' transaction.
 *
 * @since 1.2.0
 */
public class ProvideMedicationStatementAuditStrategy extends GenericFhirAuditStrategy<MedicationStatement> {

    public ProvideMedicationStatementAuditStrategy() {
