...
/**
 * Implementation of {@link org.openehealth.ipf.commons.ihe.core.atna.AuditStrategy AuditStrategy} for 'Create Observation' transaction.
 *
 * @since 1.0.0
 */
public class CreateObservationAuditStrategy extends GenericFhirAuditStrategy<Observation> {

    public CreateObservationAuditStrategy() {
