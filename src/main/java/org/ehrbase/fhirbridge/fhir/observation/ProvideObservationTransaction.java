 ...
 * @since 1.2.0
 */
public class ProvideObservationTransaction extends FhirTransactionConfiguration<GenericFhirAuditDataset> {

    public ProvideObservationTransaction() {
        super("observation-provide",
                "Provide Observation",
                false,
                null,
