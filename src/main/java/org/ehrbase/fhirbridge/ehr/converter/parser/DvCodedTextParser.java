...
public class DvCodedTextParser {
    ...
    public static Optional<DvCodedText> parseFHIRCoding(Coding coding) {
        ...
        } else if (coding.hasDisplay() && coding.hasSystem() && coding.hasCode() && coding.getSystem().equals(CodeSystem.LOINC.getUrl())) {
            return Optional.of(new DvCodedText(coding.getDisplay(), new CodePhrase(new TerminologyId("LOINC", ""), coding.getCode())));
        } else if (coding.hasCode() && coding.getSystem().equals(CodeSystem.LOINC.getUrl())) {
            return Optional.of(new DvCodedText("", new CodePhrase(new TerminologyId("LOINC", ""), coding.getCode())));
        } else {
