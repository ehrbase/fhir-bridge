 ...
 * @since 1.0.0
 */
public abstract class AbstractConverter<S extends Resource, T extends RMEntity> implements Converter<S, T> {
    ...
    protected Language resolveLanguageOrDefault(@NonNull S resource) {
