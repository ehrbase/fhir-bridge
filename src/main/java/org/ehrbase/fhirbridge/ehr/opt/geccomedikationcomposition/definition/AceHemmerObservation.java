...
@Generated(
    ...
    date = "2021-04-28T12:53:59.455147+02:00",
...
public class AceHemmerObservation implements EntryEntity {
  ...
  /**
   * Path: Medikation/ACE-Hemmer/Beliebiges Ereignis
   * Description: Standardwert, ein undefinierter/s Zeitpunkt oder Intervallereignis, das explizit im Template oder zur Laufzeit der Anwendung definiert werden kann.
   */
  @Path("/data[at0001]/events[at0002]")
  @Choice
  private List<AceHemmerBeliebigesEreignisChoice> beliebigesEreignis;
  ...
  public void setBeliebigesEreignis(List<AceHemmerBeliebigesEreignisChoice> beliebigesEreignis) {
     this.beliebigesEreignis = beliebigesEreignis;
  }

  public List<AceHemmerBeliebigesEreignisChoice> getBeliebigesEreignis() {
