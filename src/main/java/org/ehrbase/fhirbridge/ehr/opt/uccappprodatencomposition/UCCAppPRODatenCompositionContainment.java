...
public class UCCAppPRODatenCompositionContainment extends Containment {
  ...
  public SelectAqlField<BlutdruckObservation> BLUTDRUCK = new AqlFieldImp<BlutdruckObservation>(UCCAppPRODatenComposition.class, "/content[openEHR-EHR-OBSERVATION.blood_pressure.v2]", "blutdruck", BlutdruckObservation.class, this);

  public SelectAqlField<KoerpergewichtObservation> KOERPERGEWICHT = new AqlFieldImp<KoerpergewichtObservation>(UCCAppPRODatenComposition.class, "/content[openEHR-EHR-OBSERVATION.body_weight.v2]", "koerpergewicht", KoerpergewichtObservation.class, this);

  public SelectAqlField<PulsfrequenzHerzfrequenzObservation> PULSFREQUENZ_HERZFREQUENZ = new AqlFieldImp<PulsfrequenzHerzfrequenzObservation>(UCCAppPRODatenComposition.class, "/content[openEHR-EHR-OBSERVATION.pulse.v2]", "pulsfrequenzHerzfrequenz", PulsfrequenzHerzfrequenzObservation.class, this);
