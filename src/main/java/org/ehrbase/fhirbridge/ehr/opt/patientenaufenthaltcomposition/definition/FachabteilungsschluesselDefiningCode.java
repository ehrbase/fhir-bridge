...
public enum FachabteilungsschluesselDefiningCode implements EnumValueSet {
  ...
  FachabteilungsschluesselDefiningCode(String value, String description, String terminologyId,
      String code) {
    this.value = value;
