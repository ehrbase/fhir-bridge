...
@Generated(
    ...
    date = "2021-02-22T12:41:59.500910+01:00",
...
public class ProbeCluster implements LocatableEntity {
  ...
  /**
   * Path: Virologischer Befund/Befund/Jedes Ereignis/Probe/value
   */
  @Path("/items[at0015]/value|value")
  private TemporalAccessor zeitpunktDerProbenentnahmeValue;

  /**
   * Path: Virologischer Befund/Befund/Jedes Ereignis/Probe/value/lower_included
   */
  @Path("/items[at0015]/value/lower_included")
  private Boolean lowerIncluded;

  /**
   * Path: Virologischer Befund/Befund/Jedes Ereignis/Probe/value/upper_included
   */
  @Path("/items[at0015]/value/upper_included")
  private Boolean upperIncluded;

  /**
   * Path: Virologischer Befund/Befund/Jedes Ereignis/Probe/value/upper
   */
  @Path("/items[at0015]/value/upper")
  private DvOrdered upper;

  /**
   * Path: Virologischer Befund/Befund/Jedes Ereignis/Probe/value/lower
   */
