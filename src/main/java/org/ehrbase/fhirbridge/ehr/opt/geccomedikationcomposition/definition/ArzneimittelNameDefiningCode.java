...
public enum ArzneimittelNameDefiningCode implements EnumValueSet {
  ...
  STEROIDS05_MG_KG_PREDNISONE_EQUIVALENTS("Steroids (<= 0.5 mg/kg prednisone equivalents)", "", "SNOMED CT", "steroids-lt"),
  ...
  PRODUCT_CONTAINING_CAMOSTAT("Product containing camostat", "", "SNOMED CT", "camostat"),
  ...
  PRODUCT_CONTAINING_FAVIPIRAVIR("Product containing favipiravir", "", "SNOMED CT", "favipiravir"),
  ...
  CONVALESCENT_PLASMA("Convalescent plasma", "", "SNOMED CT", "convalescent-plasma"),

  PRODUCT_CONTAINING_ANTIPYRETIC("Product containing antipyretic", "", "SNOMED CT", "antipyretic"),
