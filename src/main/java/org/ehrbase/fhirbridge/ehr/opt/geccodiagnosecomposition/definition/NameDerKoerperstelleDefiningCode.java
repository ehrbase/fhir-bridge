...
public enum NameDerKoerperstelleDefiningCode implements EnumValueSet {
  ...
  public static Map<String, NameDerKoerperstelleDefiningCode> getCodesAsMap(){
    Map<String, NameDerKoerperstelleDefiningCode> nameDesProblemsDerDiagnoseDefiningCodeHashMap = new HashMap<>();
    for (NameDerKoerperstelleDefiningCode nameDerKoerperstelleDefiningCode : NameDerKoerperstelleDefiningCode.values()) {
      nameDesProblemsDerDiagnoseDefiningCodeHashMap.put(nameDerKoerperstelleDefiningCode.getCode(), nameDerKoerperstelleDefiningCode);
    }
    return nameDesProblemsDerDiagnoseDefiningCodeHashMap;
  }
