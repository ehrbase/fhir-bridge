...
public class FachlicheOrganisationseinheitClusterContainment extends Containment {
  ...
  public SelectAqlField<OrganisationsschluesselDefiningCode> ORGANISATIONSSCHLUESSEL_DEFINING_CODE = new AqlFieldImp<OrganisationsschluesselDefiningCode>(FachlicheOrganisationseinheitCluster.class, "/items[at0024]/value|defining_code", "organisationsschluesselDefiningCode", OrganisationsschluesselDefiningCode.class, this);
