...
public class ProbeCluster implements LocatableEntity {
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Probenart/null_flavour
   */
  @Path("/items[at0029]/null_flavour|defining_code")
  private NullFlavour probenartNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Laborprobenidentifikator
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Laborprobenidentifikator/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour laborprobenidentifikatorNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Externer Identifikator
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Externer Identifikator/null_flavour
   */
  @Path("/items[at0088]/null_flavour|defining_code")
  private NullFlavour externerIdentifikatorNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Zeitpunkt des Probeneingangs
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Zeitpunkt des Probeneingangs/null_flavour
   */
  @Path("/items[at0034]/null_flavour|defining_code")
  private NullFlavour zeitpunktDesProbeneingangsNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Physische Eigenschaften
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Kommentar des Probennehmers
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Kommentar des Probennehmers/null_flavour
   */
  @Path("/items[at0079]/null_flavour|defining_code")
  private NullFlavour kommentarDesProbennehmersNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Anatomische Lokalisation
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Zeitpunkt der Probenentnahme/null_flavour
   */
  @Path("/items[at0015]/null_flavour|defining_code")
  private NullFlavour zeitpunktDerProbenentnahmeNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Identifikator des Probennehmers
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Identifikator des Probennehmers/null_flavour
   */
  @Path("/items[at0070]/null_flavour|defining_code")
  private NullFlavour identifikatorDesProbennehmersNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Angaben zum Probennehmer
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Zusätzliche Angaben zur Probennahme
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Behälter Details
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Angaben zur Verarbeitung
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Angaben zum Transport
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Digitale Darstellung
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Identifikator der übergeordneten Probe
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Identifikator der übergeordneten Probe/null_flavour
   */
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Kommentar
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Event Series/Jedes Ereignis/Tree/Probe/Kommentar/null_flavour
   */
  @Path("/items[at0045]/null_flavour|defining_code")
  private NullFlavour kommentarNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/feeder_audit
   */
  @Path("/feeder_audit")
  private FeederAudit feederAudit;

  /**
   * Path: Mikrobiologischer Befund/Befund/Jedes Ereignis/Probe/Zeitpunkt der Probenentnahme
