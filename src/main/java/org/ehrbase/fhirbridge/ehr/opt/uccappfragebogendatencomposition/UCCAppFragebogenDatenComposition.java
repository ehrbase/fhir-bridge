...
@Generated(
    ...
    date = "2022-05-10T15:34:39.400285159+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.19.0-SNAPSHOT"
)
@Template("UCC_App_Fragebogen_Daten")
public class UCCAppFragebogenDatenComposition implements CompositionEntity {
  /**
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis
   * Description: Generische Repräsentation von Fragebögen, die vom Patienten ausgefüllt werden.
   */
  @Path("/content[openEHR-EHR-OBSERVATION.questionnaire_entry.v0 and name/value='Gesamtergebnis']")
  private GesamtergebnisObservation gesamtergebnis;
  ...
  public void setGesamtergebnis(GesamtergebnisObservation gesamtergebnis) {
     this.gesamtergebnis = gesamtergebnis;
  }

  public GesamtergebnisObservation getGesamtergebnis() {
