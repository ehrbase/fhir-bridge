...
public class SOFACompositionContainment extends Containment {
  ...
  public ListSelectAqlField<SofaScoreKategorieElement> KATEGORIE = new ListAqlFieldImp<SofaScoreKategorieElement>(SOFAComposition.class, "/context/other_context[at0001]/items[at0005]", "kategorie", SofaScoreKategorieElement.class, this);
