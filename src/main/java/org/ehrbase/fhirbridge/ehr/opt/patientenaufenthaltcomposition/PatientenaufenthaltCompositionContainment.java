...
public class PatientenaufenthaltCompositionContainment extends Containment {
  ...
  public SelectAqlField<VersorgungstellenkontaktCluster> VERSORGUNGSTELLENKONTAKT = new AqlFieldImp<VersorgungstellenkontaktCluster>(PatientenaufenthaltComposition.class, "/context/other_context[at0001]/items[openEHR-EHR-CLUSTER.case_identification.v0]", "versorgungstellenkontakt", VersorgungstellenkontaktCluster.class, this);
  ...
  public SelectAqlField<VersorgungsaufenthaltAdminEntry> VERSORGUNGSAUFENTHALT = new AqlFieldImp<VersorgungsaufenthaltAdminEntry>(PatientenaufenthaltComposition.class, "/content[openEHR-EHR-ADMIN_ENTRY.hospitalization.v0]", "versorgungsaufenthalt", VersorgungsaufenthaltAdminEntry.class, this);
