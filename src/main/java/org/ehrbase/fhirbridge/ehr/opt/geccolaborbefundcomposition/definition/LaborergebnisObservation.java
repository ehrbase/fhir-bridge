...
@Generated(
    ...
    date = "2021-10-20T12:36:28.970898+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class LaborergebnisObservation implements EntryEntity {
  /**
   * Path: Laborbefund/Laborergebnis/Jedes Ereignis/Labortest-Kategorie
  ...
  /**
   * Path: Laborbefund/Laborergebnis/Event Series/Jedes Ereignis/Tree/Schlussfolgerung/null_flavour
   */
  ...
  /**
   * Path: Laborbefund/Laborergebnis/Labor, welches den Untersuchungsauftrag annimmt
  ...
  /**
   * Path: Laborbefund/Laborergebnis/Tree/Details der Testanforderung/Identifikation der Laboranforderung/null_flavour
   */
  ...
  /**
   * Path: Laborbefund/Laborergebnis/Tree/Testmethode/null_flavour
   */
  ...
  /**
   * Path: Laborbefund/Laborergebnis/Details der Testanforderung/Identifikation der Laboranforderung
