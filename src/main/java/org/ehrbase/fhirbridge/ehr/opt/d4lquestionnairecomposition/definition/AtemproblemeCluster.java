...
@Generated(
    ...
    date = "2021-01-25T13:06:41.034938+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.0.0"
)
public class AtemproblemeCluster implements LocatableEntity {
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Name des Symptoms/Krankheitsanzeichens
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Atemprobleme/Name des Symptoms/Krankheitsanzeichens/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour nameDesSymptomsKrankheitsanzeichensNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Vorhanden?
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Atemprobleme/Vorhanden?/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Spezifische anatomische Lokalisation
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Spezifische Details
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Vorangegangene Episoden
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/Assoziierte Symptome/Krankheitsanzeichen
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Atemprobleme/feeder_audit
   */
  @Path("/feeder_audit")
