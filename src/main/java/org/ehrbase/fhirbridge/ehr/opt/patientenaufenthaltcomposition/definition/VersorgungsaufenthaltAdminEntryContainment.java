...
public class VersorgungsaufenthaltAdminEntryContainment extends Containment {
  ...
  public SelectAqlField<StandortCluster> STANDORT = new AqlFieldImp<StandortCluster>(VersorgungsaufenthaltAdminEntry.class, "/data[at0001]/items[openEHR-EHR-CLUSTER.location.v1]", "standort", StandortCluster.class, this);
  ...
  public SelectAqlField<String> KOMMENTAR_VALUE = new AqlFieldImp<String>(VersorgungsaufenthaltAdminEntry.class, "/data[at0001]/items[at0009]/value|value", "kommentarValue", String.class, this);

  public SelectAqlField<NullFlavour> KOMMENTAR_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(VersorgungsaufenthaltAdminEntry.class, "/data[at0001]/items[at0009]/null_flavour|defining_code", "kommentarNullFlavourDefiningCode", NullFlavour.class, this);
