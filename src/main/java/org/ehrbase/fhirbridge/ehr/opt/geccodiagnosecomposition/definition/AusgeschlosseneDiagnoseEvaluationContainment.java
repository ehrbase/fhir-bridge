...
public class AusgeschlosseneDiagnoseEvaluationContainment extends Containment {
  ...
  public SelectAqlField<ProblemDiagnoseDefiningCode> PROBLEM_DIAGNOSE_DEFINING_CODE = new AqlFieldImp<ProblemDiagnoseDefiningCode>(AusgeschlosseneDiagnoseEvaluation.class, "/data[at0001]/items[at0003]/value|defining_code", "problemDiagnoseDefiningCode", ProblemDiagnoseDefiningCode.class, this);
