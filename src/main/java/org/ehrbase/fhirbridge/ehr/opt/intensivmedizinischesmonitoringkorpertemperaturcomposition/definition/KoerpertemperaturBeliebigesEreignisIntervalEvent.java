...
@Generated(
    ...
    date = "2021-03-09T11:54:08.613499+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
@OptionFor("INTERVAL_EVENT")
public class KoerpertemperaturBeliebigesEreignisIntervalEvent implements IntervalEventEntity, KoerpertemperaturBeliebigesEreignisChoice {
  /**
  ...
  /**
   * Path: Bericht/Körpertemperatur/Beliebiges Ereignis/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Bericht/Körpertemperatur/Beliebiges Ereignis/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Bericht/Körpertemperatur/Beliebiges Ereignis/sample_count
   */
  @Path("/sample_count")
