...
public enum AetiologieDerKrankheitDefiningCode implements EnumValueSet {
  ...
  KOERPERLICHE_VERLETZUNG("Körperliche Verletzung", "z.B. Kopftrauma, Hitzeerschöpfung, Verletzung durch Strahlenbelastung", "local", "at0012"),
  ...
  ERNAEHRUNGSRELEVANTE_FAKTOREN("Ernährungsrelevante Faktoren", "z. B. Eisenmangel, kohlenhydratreiche Ernährung", "local", "at0008");
  ...
  AetiologieDerKrankheitDefiningCode(String value, String description, String terminologyId,
      String code) {
    this.value = value;
