...
@Generated(
    ...
    date = "2021-03-09T11:55:59.484743+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
public class DetailsZurKoerperstelleCluster implements LocatableEntity {
  /**
   * Path: Prozedur/Prozedur/Details zur Körperstelle/Name der Körperstelle
  ...
  /**
   * Path: Prozedur/Prozedur/Tree/Details zur Körperstelle/Name der Körperstelle/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour nameDerKoerperstelleNullFlavourDefiningCode;

  /**
   * Path: Prozedur/Prozedur/Details zur Körperstelle/Lateralität
  ...
  /**
   * Path: Prozedur/Prozedur/Tree/Details zur Körperstelle/Lateralität/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour lateralitaetNullFlavourDefiningCode;

  /**
   * Path: Prozedur/Prozedur/Details zur Körperstelle/Alternative Struktur
  ...
  /**
   * Path: Prozedur/Prozedur/Details zur Körperstelle/Multimediale Darstellung
  ...
  /**
   * Path: Prozedur/Prozedur/Details zur Körperstelle/feeder_audit
   */
  @Path("/feeder_audit")
