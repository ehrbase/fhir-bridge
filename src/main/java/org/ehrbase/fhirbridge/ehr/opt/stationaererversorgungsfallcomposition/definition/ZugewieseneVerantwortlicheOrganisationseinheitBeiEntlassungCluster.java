...
@Generated(
    ...
    date = "2021-03-30T13:55:38.307844500+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
public class ZugewieseneVerantwortlicheOrganisationseinheitBeiEntlassungCluster implements LocatableEntity {
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Typ
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Typ/null_flavour
   */
  @Path("/items[at0051]/null_flavour|defining_code")
  private NullFlavour typNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Organisationsschlüssel
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Organisationsschlüssel/null_flavour
   */
  @Path("/items[at0024]/null_flavour|defining_code")
  private NullFlavour organisationsschluesselNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Name
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Name/null_flavour
   */
  @Path("/items[at0052]/null_flavour|defining_code")
  private NullFlavour nameNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Aktiv/Inaktiv
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Aktiv/Inaktiv/null_flavour
   */
  @Path("/items[at0050]/null_flavour|defining_code")
  private NullFlavour aktivInaktivNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Zusätzliche Beschreibung
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Zusätzliche Beschreibung/null_flavour
   */
  @Path("/items[at0046]/null_flavour|defining_code")
  private NullFlavour zusaetzlicheBeschreibungNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/Details
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesene verantwortliche Organisationseinheit (bei Entlassung)/feeder_audit
   */
  @Path("/feeder_audit")
