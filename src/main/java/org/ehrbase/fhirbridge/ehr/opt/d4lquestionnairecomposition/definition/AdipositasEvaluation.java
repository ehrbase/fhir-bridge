...
@Generated(
    ...
    date = "2021-01-25T13:06:41.151910+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.0.0"
)
public class AdipositasEvaluation implements EntryEntity {
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Name des Problems/ der Diagnose
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Structure/Name des Problems/ der Diagnose/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Vorhanden?
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Structure/Vorhanden?/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Anatomische Stelle (strukturiert)
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Spezifische Angaben
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Status
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/Erweiterung
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Adipositas/feeder_audit
   */
  @Path("/feeder_audit")
