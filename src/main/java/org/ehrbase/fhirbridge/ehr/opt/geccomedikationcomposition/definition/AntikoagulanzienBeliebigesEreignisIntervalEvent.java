...
@Generated(
    ...
    date = "2021-10-11T15:28:13.056122+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
@OptionFor("INTERVAL_EVENT")
public class AntikoagulanzienBeliebigesEreignisIntervalEvent implements IntervalEventEntity, AntikoagulanzienBeliebigesEreignisChoice {
  /**
  ...
  /**
   * Path: Medikation/Antikoagulanzien/Beliebiges Ereignis/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Medikation/Antikoagulanzien/Beliebiges Ereignis/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Medikation/Antikoagulanzien/Beliebiges Ereignis/sample_count
   */
  @Path("/sample_count")
