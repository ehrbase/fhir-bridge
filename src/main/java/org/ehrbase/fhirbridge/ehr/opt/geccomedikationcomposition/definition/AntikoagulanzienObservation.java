...
@Generated(
    ...
    date = "2021-04-28T12:53:59.511759+02:00",
...
public class AntikoagulanzienObservation implements EntryEntity {
  ...
  /**
   * Path: Medikation/Antikoagulanzien/Beliebiges Ereignis
   * Description: Standardwert, ein undefinierter/s Zeitpunkt oder Intervallereignis, das explizit im Template oder zur Laufzeit der Anwendung definiert werden kann.
   */
  @Path("/data[at0001]/events[at0002]")
  @Choice
  private List<AntikoagulanzienBeliebigesEreignisChoice> beliebigesEreignis;
  ...
  public void setBeliebigesEreignis(
      List<AntikoagulanzienBeliebigesEreignisChoice> beliebigesEreignis) {
     this.beliebigesEreignis = beliebigesEreignis;
  }

  public List<AntikoagulanzienBeliebigesEreignisChoice> getBeliebigesEreignis() {
