...
public class GECCODiagnoseCompositionContainment extends Containment {
  ...
  public SelectAqlField<StatusDefiningcode> STATUS_DEFININGCODE = new AqlFieldImp<StatusDefiningcode>(GECCODiagnoseComposition.class, "/context/other_context[at0001]/items[at0004]/value|defining_code", "statusDefiningcode", StatusDefiningcode.class, this);

  public SelectAqlField<KategorieDefiningcode> KATEGORIE_DEFININGCODE = new AqlFieldImp<KategorieDefiningcode>(GECCODiagnoseComposition.class, "/context/other_context[at0001]/items[at0005]/value|defining_code", "kategorieDefiningcode", KategorieDefiningcode.class, this);
  ...
  public SelectAqlField<AusgeschlosseneDiagnoseEvaluation> AUSGESCHLOSSENE_DIAGNOSE = new AqlFieldImp<AusgeschlosseneDiagnoseEvaluation>(GECCODiagnoseComposition.class, "/content[openEHR-EHR-EVALUATION.exclusion_specific.v1 and name/value='Ausgeschlossene Diagnose']", "ausgeschlosseneDiagnose", AusgeschlosseneDiagnoseEvaluation.class, this);
  ...
  public SelectAqlField<UnbekannteDiagnoseEvaluation> UNBEKANNTE_DIAGNOSE = new AqlFieldImp<UnbekannteDiagnoseEvaluation>(GECCODiagnoseComposition.class, "/content[openEHR-EHR-EVALUATION.absence.v2 and name/value='Unbekannte Diagnose']", "unbekannteDiagnose", UnbekannteDiagnoseEvaluation.class, this);
  ...
  public SelectAqlField<SettingDefiningcode> SETTING_DEFININGCODE = new AqlFieldImp<SettingDefiningcode>(GECCODiagnoseComposition.class, "/context/setting|defining_code", "settingDefiningcode", SettingDefiningcode.class, this);
  ...
  public SelectAqlField<VorliegendeDiagnoseEvaluation> VORLIEGENDE_DIAGNOSE = new AqlFieldImp<VorliegendeDiagnoseEvaluation>(GECCODiagnoseComposition.class, "/content[openEHR-EHR-EVALUATION.problem_diagnosis.v1 and name/value='Vorliegende Diagnose']", "vorliegendeDiagnose", VorliegendeDiagnoseEvaluation.class, this);
  ...
  public SelectAqlField<CategoryDefiningcode> CATEGORY_DEFININGCODE = new AqlFieldImp<CategoryDefiningcode>(GECCODiagnoseComposition.class, "/category|defining_code", "categoryDefiningcode", CategoryDefiningcode.class, this);
