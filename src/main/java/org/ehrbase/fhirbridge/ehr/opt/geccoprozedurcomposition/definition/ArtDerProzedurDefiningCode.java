...
public enum ArtDerProzedurDefiningCode implements EnumValueSet {
  ...
  ArtDerProzedurDefiningCode(String value, String description, String terminologyId, String code) {
    this.value = value;
