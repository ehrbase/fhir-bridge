...
public class DiabetesEvaluationContainment extends Containment {
  ...
  public SelectAqlField<NullFlavour> NAME_DES_PROBLEMS_DER_DIAGNOSE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(DiabetesEvaluation.class, "/data[at0001]/items[at0002]/null_flavour|defining_code", "nameDesProblemsDerDiagnoseNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<VorhandenDefiningCode> VORHANDEN_DEFINING_CODE = new AqlFieldImp<VorhandenDefiningCode>(DiabetesEvaluation.class, "/data[at0001]/items[at0009]/value|defining_code", "vorhandenDefiningCode", VorhandenDefiningCode.class, this);

  public SelectAqlField<NullFlavour> VORHANDEN_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(DiabetesEvaluation.class, "/data[at0001]/items[at0009]/null_flavour|defining_code", "vorhandenNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<FeederAudit> FEEDER_AUDIT = new AqlFieldImp<FeederAudit>(DiabetesEvaluation.class, "/feeder_audit", "feederAudit", FeederAudit.class, this);
