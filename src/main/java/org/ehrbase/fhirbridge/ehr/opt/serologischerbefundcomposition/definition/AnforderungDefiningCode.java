...
public enum AnforderungDefiningCode implements EnumValueSet {
  SARS_COV2_COVID19_AB_PANEL_SERUM_OR_PLASMA_BY_IMMUNOASSAY("SARS-CoV-2 (COVID-19) Ab Panel - Serum or Plasma by Immunoassay", "SARS-CoV-2 (COVID-19) Ab Panel - Serum or Plasma by Immunoassay", "LOINC", "94504-8");
