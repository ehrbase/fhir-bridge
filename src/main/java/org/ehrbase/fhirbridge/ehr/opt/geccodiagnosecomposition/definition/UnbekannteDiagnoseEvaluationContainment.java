...
public class UnbekannteDiagnoseEvaluationContainment extends Containment {
  ...
  public SelectAqlField<ProblemDiagnoseDefiningCode> UNBEKANNTE_DIAGNOSE_DEFINING_CODE = new AqlFieldImp<ProblemDiagnoseDefiningCode>(UnbekannteDiagnoseEvaluation.class, "/data[at0001]/items[at0002]/value|defining_code", "unbekannteDiagnoseDefiningCode", ProblemDiagnoseDefiningCode.class, this);
