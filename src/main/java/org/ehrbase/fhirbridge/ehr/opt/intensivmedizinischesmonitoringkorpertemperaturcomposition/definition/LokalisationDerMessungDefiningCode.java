...
public enum LokalisationDerMessungDefiningCode implements EnumValueSet {
  ...
  SCHLAEFE("Schläfe", "Messung der Temperatur an der Schläfe, über der oberflächlichen Schläfenarterie.", "local", "at0060"),
  ...
  ACHSELHOEHLE("Achselhöhle", "Messung der Temperatur an der Haut der Achselhöhle mit seitlich angelegtem Arm.", "local", "at0024"),

  INGUINALE_HAUTFALTE("Inguinale Hautfalte", "Messung der Temperatur in der inguinalen Hautfalte zwischen Bein und Abdominalwand.", "local", "at0055"),

  INTRAVASKULAER("Intravaskulär", "Messung der Temperatur innerhalb des vaskulären Systems.", "local", "at0028"),
