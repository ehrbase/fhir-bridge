...
public class HerzfrequenzCompositionContainment extends Containment {
  ...
  public ListSelectAqlField<Cluster> EXTENSION = new ListAqlFieldImp<Cluster>(HerzfrequenzComposition.class, "/context/other_context[at0001]/items[at0002]", "extension", Cluster.class, this);
  ...
  public ListSelectAqlField<RegisterEntryCategoryElement> CATEGORY = new ListAqlFieldImp<RegisterEntryCategoryElement>(HerzfrequenzComposition.class, "/context/other_context[at0001]/items[at0005]", "category", RegisterEntryCategoryElement.class, this);
  ...
  public SelectAqlField<PulseHeartBeatObservation> PULSE_HEART_BEAT = new AqlFieldImp<PulseHeartBeatObservation>(HerzfrequenzComposition.class, "/content[openEHR-EHR-OBSERVATION.pulse.v2]", "pulseHeartBeat", PulseHeartBeatObservation.class, this);
