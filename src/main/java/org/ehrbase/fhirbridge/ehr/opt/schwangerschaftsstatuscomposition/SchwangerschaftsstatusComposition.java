...
public class SchwangerschaftsstatusComposition implements CompositionEntity {
  ...
  private List<SchwangerschaftsstatusKategorieElement> kategorie;
  ...
  public void setKategorie(List<SchwangerschaftsstatusKategorieElement> kategorie) {
     this.kategorie = kategorie;
  }

  public List<SchwangerschaftsstatusKategorieElement> getKategorie() {
