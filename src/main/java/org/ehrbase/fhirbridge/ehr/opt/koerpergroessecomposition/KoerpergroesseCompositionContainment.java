...
public class KoerpergroesseCompositionContainment extends Containment {
  ...
  public ListSelectAqlField<KoerpergroesseKategorieElement> KATEGORIE = new ListAqlFieldImp<KoerpergroesseKategorieElement>(KoerpergroesseComposition.class, "/context/other_context[at0001]/items[at0005]", "kategorie", KoerpergroesseKategorieElement.class, this);
