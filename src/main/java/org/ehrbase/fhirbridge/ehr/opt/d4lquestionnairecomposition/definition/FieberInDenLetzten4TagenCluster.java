...
@Generated(
    ...
    date = "2021-01-13T15:23:34.741690+01:00",
...
public class FieberInDenLetzten4TagenCluster implements LocatableEntity {
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Fieber in den letzten 4 Tagen/Name des Symptoms/Krankheitsanzeichens/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Fieber in den letzten 4 Tagen/Vorhanden?/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Fieber in den letzten 4 Tagen/Spezifische anatomische Lokalisation
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Fieber in den letzten 4 Tagen/Schweregrad/null_flavour
   */
  @Path("/items[at0021]/null_flavour|defining_code")
  private NullFlavour schweregradNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Fieber in den letzten 4 Tagen/Spezifische Details
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Fieber in den letzten 4 Tagen/Vorangegangene Episoden
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Fieber in den letzten 4 Tagen/Assoziierte Symptome/Krankheitsanzeichen
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Fieber in den letzten 4 Tagen/feeder_audit
   */
  @Path("/feeder_audit")
