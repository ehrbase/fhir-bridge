...
public class GECCOLaborbefundCompositionContainment extends Containment {
  ...
  public ListSelectAqlField<LaborbefundKategorieElement> KATEGORIE = new ListAqlFieldImp<LaborbefundKategorieElement>(GECCOLaborbefundComposition.class, "/context/other_context[at0001]/items[at0005]", "kategorie", LaborbefundKategorieElement.class, this);
