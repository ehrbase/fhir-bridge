...
public class ZugewiesenerStandortBeiEntlassungCluster implements LocatableEntity {
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Campus
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Campus/null_flavour
   */
  @Path("/items[at0024]/null_flavour|defining_code")
  private NullFlavour campusNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Gebäudegruppe
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Gebäudegruppe/null_flavour
   */
  @Path("/items[at0025]/null_flavour|defining_code")
  private NullFlavour gebaeudegruppeNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Ebene
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Ebene/null_flavour
   */
  @Path("/items[at0028]/null_flavour|defining_code")
  private NullFlavour ebeneNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Station
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Station/null_flavour
   */
  @Path("/items[at0027]/null_flavour|defining_code")
  private NullFlavour stationNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Zimmer
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Zimmer/null_flavour
   */
  @Path("/items[at0029]/null_flavour|defining_code")
  private NullFlavour zimmerNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Bettstellplatz
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Bettstellplatz/null_flavour
   */
  @Path("/items[at0034]/null_flavour|defining_code")
  private NullFlavour bettstellplatzNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Zusätzliche Beschreibung
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Tree/Zugewiesener Standort (bei Entlassung)/Zusätzliche Beschreibung/null_flavour
   */
  @Path("/items[at0046]/null_flavour|defining_code")
  private NullFlavour zusaetzlicheBeschreibungNullFlavourDefiningCode;

  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Details
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/Leitende Organisationseinheit
  ...
  /**
   * Path: Stationärer Versorgungsfall/Entlassungsdaten/Zugewiesener Standort (bei Entlassung)/feeder_audit
   */
  @Path("/feeder_audit")
