...
public enum SchweregradDefiningCode implements EnumValueSet {
  ...
  MAESSIG("Mäßig", "Das Problem oder die Diagnose beeinträchtigt die normale Aktivität oder verursacht bleibende gesundheitliche Schäden, falls es nicht behandelt wird.", "local", "at0048"),
