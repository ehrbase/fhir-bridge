...
public class KoerperstelleClusterContainment extends Containment {
  ...
  public SelectAqlField<DvCodedText> NAME_DER_KOERPERSTELLE = new AqlFieldImp<DvCodedText>(KoerperstelleCluster.class, "/items[at0001]/value", "nameDerKoerperstelle", DvCodedText.class, this);
