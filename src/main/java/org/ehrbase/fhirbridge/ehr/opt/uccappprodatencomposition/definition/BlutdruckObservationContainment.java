...
public class BlutdruckObservationContainment extends Containment {
  ...
  public ListSelectAqlField<BlutdruckBeliebigesEreignisChoice> BELIEBIGES_EREIGNIS = new ListAqlFieldImp<BlutdruckBeliebigesEreignisChoice>(BlutdruckObservation.class, "/data[at0001]/events[at0006]", "beliebigesEreignis", BlutdruckBeliebigesEreignisChoice.class, this);
