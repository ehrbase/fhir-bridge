...
@Generated(
    ...
    date = "2020-12-18T10:30:38.821837+01:00",
...
public class HerzerkrankungEvaluation implements EntryEntity {
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Structure/Name des Problems/ der Diagnose/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Structure/Vorhanden?/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Anatomische Stelle (strukturiert)
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Spezifische Angaben
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Status
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/Erweiterung
  ...
  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Selbstüberwachung/Vor-/Grunderkrankungen/Herzerkrankung/feeder_audit
   */
  @Path("/feeder_audit")
