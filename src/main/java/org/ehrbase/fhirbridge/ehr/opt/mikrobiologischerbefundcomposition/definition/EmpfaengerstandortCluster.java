...
@Generated(
    ...
    date = "2024-02-20T15:55:44.399449770+01:00",
...
public class EmpfaengerstandortCluster implements LocatableEntity {
  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Typ
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Tree/Empfängerstandort/Typ/null_flavour
   */
  @Path("/items[at0051]/null_flavour|defining_code")
  private NullFlavour typNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Organisationsschlüssel
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Tree/Empfängerstandort/Organisationsschlüssel/null_flavour
   */
  @Path("/items[at0024]/null_flavour|defining_code")
  private NullFlavour organisationsschluesselNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Name
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Tree/Empfängerstandort/Name/null_flavour
   */
  @Path("/items[at0052]/null_flavour|defining_code")
  private NullFlavour nameNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Aktiv/Inaktiv
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Tree/Empfängerstandort/Aktiv/Inaktiv/null_flavour
   */
  @Path("/items[at0050]/null_flavour|defining_code")
  private NullFlavour aktivInaktivNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Zusätzliche Beschreibung
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Tree/Empfängerstandort/Zusätzliche Beschreibung/null_flavour
   */
  @Path("/items[at0046]/null_flavour|defining_code")
  private NullFlavour zusaetzlicheBeschreibungNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/Details
  ...
  /**
   * Path: Mikrobiologischer Befund/Befund/Empfängerstandort/feeder_audit
   */
  @Path("/feeder_audit")
