...
@Generated(
    ...
    date = "2021-03-09T11:54:20.626252+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
public class FallidentifikationCluster implements LocatableEntity {
  /**
   * Path: Kennzeichnung Erregernachweis SARS-CoV-2/context/Fallidentifikation/Fall-Kennung
  ...
  /**
   * Path: Kennzeichnung Erregernachweis SARS-CoV-2/context/Tree/Fallidentifikation/Fall-Kennung/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour fallKennungNullFlavourDefiningCode;

  /**
   * Path: Kennzeichnung Erregernachweis SARS-CoV-2/context/Fallidentifikation/feeder_audit
   */
  @Path("/feeder_audit")
