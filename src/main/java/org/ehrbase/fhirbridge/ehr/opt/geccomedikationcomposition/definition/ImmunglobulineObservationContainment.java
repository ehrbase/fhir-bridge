...
public class ImmunglobulineObservationContainment extends Containment {
  ...
  public SelectAqlField<DvCodedText> ARZNEIMITTEL_NAME = new AqlFieldImp<DvCodedText>(ImmunglobulineObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0006]/value", "arzneimittelName", DvCodedText.class, this);
  ...
  public SelectAqlField<DvCodedText> GRUND = new AqlFieldImp<DvCodedText>(ImmunglobulineObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0023]/value", "grund", DvCodedText.class, this);
