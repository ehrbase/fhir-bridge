...
@Generated(
    ...
    date = "2021-01-25T13:06:41.023213+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.0.0"
)
public class HalsschmerzenInDenLetzten24StundenCluster implements LocatableEntity {
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Name des Symptoms/Krankheitsanzeichens
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Halsschmerzen in den letzten 24 Stunden/Name des Symptoms/Krankheitsanzeichens/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour nameDesSymptomsKrankheitsanzeichensNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Vorhanden?
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Structure/Halsschmerzen in den letzten 24 Stunden/Vorhanden?/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Spezifische anatomische Lokalisation
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Spezifische Details
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Vorangegangene Episoden
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/Assoziierte Symptome/Krankheitsanzeichen
  ...
  /**
   * Path: Selbstüberwachung/Symptome/Problem/Diagnose/Halsschmerzen in den letzten 24 Stunden/feeder_audit
   */
  @Path("/feeder_audit")
