...
@Generated(
    ...
    date = "2021-09-06T16:23:11.842426+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.5.0"
)
public class NichtDurchgefuehrteProzedurEvaluation implements EntryEntity {
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/Aussage über den Ausschluss
  ...
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/Tree/Aussage über den Ausschluss/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/Eingriff
  ...
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/Tree/Eingriff/null_flavour
   */
  ...
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/Erweiterung
  ...
  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Registereintrag/Nicht durchgeführte Prozedur/feeder_audit
   */
  @Path("/feeder_audit")
