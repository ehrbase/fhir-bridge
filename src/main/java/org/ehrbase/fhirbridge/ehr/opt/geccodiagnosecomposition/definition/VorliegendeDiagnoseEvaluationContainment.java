...
public class VorliegendeDiagnoseEvaluationContainment extends Containment {
  ...
  public SelectAqlField<ProblemDiagnoseDefiningcode> NAME_DES_PROBLEMS_DER_DIAGNOSE_DEFININGCODE = new AqlFieldImp<ProblemDiagnoseDefiningcode>(VorliegendeDiagnoseEvaluation.class, "/data[at0001]/items[at0002]/value|defining_code", "nameDesProblemsDerDiagnoseDefiningcode", ProblemDiagnoseDefiningcode.class, this);
