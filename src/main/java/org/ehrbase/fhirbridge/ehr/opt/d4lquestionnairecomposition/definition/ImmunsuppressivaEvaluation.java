...
@Generated(
    ...
    date = "2021-04-22T17:20:48.228478+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
public class ImmunsuppressivaEvaluation implements EntryEntity {
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Name des Medikaments
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Tree/Name des Medikaments/null_flavour
   */
  @Path("/data[at0001]/items[at0002]/null_flavour|defining_code")
  private NullFlavour nameDesMedikamentsNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Status
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Tree/Status/null_flavour
   */
  @Path("/data[at0001]/items[at0023]/null_flavour|defining_code")
  private NullFlavour statusNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Klinische Indikation
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Tree/Klinische Indikation/null_flavour
   */
  @Path("/data[at0001]/items[at0028]/null_flavour|defining_code")
  private NullFlavour klinischeIndikationNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Datum der letzten Aktualisierung
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Tree/Datum der letzten Aktualisierung/null_flavour
   */
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/Erweiterung
  ...
  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/subject
   */
  @Path("/subject")
  private PartyProxy subject;

  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/language
   */
  @Path("/language")
  private Language language;

  /**
   * Path: Selbstüberwachung/Medikamente / Impfungen/Immunsuppressiva/feeder_audit
   */
  @Path("/feeder_audit")
