...
@Generated(
    ...
    date = "2021-03-09T11:55:59.458555+01:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
public class FallidentifikationCluster implements LocatableEntity {
  /**
   * Path: Prozedur/context/Fallidentifikation/Fall-Kennung
  ...
  /**
   * Path: Prozedur/context/Tree/Fallidentifikation/Fall-Kennung/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour fallKennungNullFlavourDefiningCode;

  /**
   * Path: Prozedur/context/Fallidentifikation/feeder_audit
   */
  @Path("/feeder_audit")
