...
@Generated(
    ...
    date = "2021-04-28T12:53:59.406123+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.3.0"
)
@OptionFor("INTERVAL_EVENT")
public class Covid19TherapieBeliebigesEreignisIntervalEvent implements IntervalEventEntity, Covid19TherapieBeliebigesEreignisChoice {
  /**
  ...
  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/Tree/Arzneimittel-Name/null_flavour
   */
  ...
  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/Tree/Status/null_flavour
   */
  ...
  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/Tree/Grund/null_flavour
   */
  ...
  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/feeder_audit
   */
  @Path("/feeder_audit")
  ...
  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/width
   */
  @Path("/width|value")
  private TemporalAmount widthValue;

  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/math_function
   */
  @Path("/math_function|defining_code")
  private MathFunction mathFunctionDefiningCode;

  /**
   * Path: Medikation/COVID-19 Therapie/Beliebiges Ereignis/sample_count
   */
  @Path("/sample_count")
