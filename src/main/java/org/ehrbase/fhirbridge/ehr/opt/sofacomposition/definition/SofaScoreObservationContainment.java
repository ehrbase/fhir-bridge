...
public class SofaScoreObservationContainment extends Containment {
  ...
  public SelectAqlField<DvOrdinal> ATEMTAETIGKEIT = new AqlFieldImp<DvOrdinal>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]/value", "atemtaetigkeit", DvOrdinal.class, this);

  public SelectAqlField<NullFlavour> ATEMTAETIGKEIT_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0004]/null_flavour|defining_code", "atemtaetigkeitNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> ZENTRALES_NERVENSYSTEM_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0005]/null_flavour|defining_code", "zentralesNervensystemNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> HERZ_KREISLAUF_SYSTEM_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0006]/null_flavour|defining_code", "herzKreislaufSystemNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> LEBERFUNKTION_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0007]/null_flavour|defining_code", "leberfunktionNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> BLUTGERINNUNG_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0008]/null_flavour|defining_code", "blutgerinnungNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> NIERENFUNKTION_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0009]/null_flavour|defining_code", "nierenfunktionNullFlavourDefiningCode", NullFlavour.class, this);
  ...
  public SelectAqlField<NullFlavour> SOFA_SCORE_NULL_FLAVOUR_DEFINING_CODE = new AqlFieldImp<NullFlavour>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/data[at0003]/items[at0010]/null_flavour|defining_code", "sofaScoreNullFlavourDefiningCode", NullFlavour.class, this);

  public SelectAqlField<ItemTree> BAUM = new AqlFieldImp<ItemTree>(SofaScoreObservation.class, "/data[at0001]/events[at0002]/state[at0013]", "baum", ItemTree.class, this);
