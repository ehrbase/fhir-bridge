...
@Generated(
    ...
    date = "2024-02-20T15:55:44.350667576+01:00",
...
public class FallidentifikationCluster implements LocatableEntity {
  /**
   * Path: Mikrobiologischer Befund/context/Fallidentifikation/Fall-Kennung
  ...
  /**
   * Path: Mikrobiologischer Befund/context/Tree/Fallidentifikation/Fall-Kennung/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour fallKennungNullFlavourDefiningCode;

  /**
   * Path: Mikrobiologischer Befund/context/Fallidentifikation/feeder_audit
   */
  @Path("/feeder_audit")
