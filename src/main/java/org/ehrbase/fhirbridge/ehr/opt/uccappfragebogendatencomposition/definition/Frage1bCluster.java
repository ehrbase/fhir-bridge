...
@Generated(
    ...
    date = "2022-05-10T15:34:39.462057928+02:00",
    comments = "https://github.com/ehrbase/openEHR_SDK Version: 1.19.0-SNAPSHOT"
)
public class Frage1bCluster implements LocatableEntity {
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/Element ID
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Event Series/Jedes Ereignis/Baum/Gesamtstatus/Frage 1/Frage 1b/Element ID/null_flavour
   */
  @Path("/items[at0002]/null_flavour|defining_code")
  private NullFlavour elementIdNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/Frage
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Event Series/Jedes Ereignis/Baum/Gesamtstatus/Frage 1/Frage 1b/Frage/null_flavour
   */
  @Path("/items[at0001]/null_flavour|defining_code")
  private NullFlavour frageNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/Antwort
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Event Series/Jedes Ereignis/Baum/Gesamtstatus/Frage 1/Frage 1b/Antwort/null_flavour
   */
  @Path("/items[at0003]/null_flavour|defining_code")
  private NullFlavour antwortNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/Score
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Event Series/Jedes Ereignis/Baum/Gesamtstatus/Frage 1/Frage 1b/Score/null_flavour
   */
  @Path("/items[at0004]/null_flavour|defining_code")
  private NullFlavour scoreNullFlavourDefiningCode;

  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/Details zum Fragebogenelement
  ...
  /**
   * Path: Selbstüberwachung/Gesamtergebnis/Jedes Ereignis/Gesamtstatus/Frage 1/Frage 1b/feeder_audit
   */
  @Path("/feeder_audit")
