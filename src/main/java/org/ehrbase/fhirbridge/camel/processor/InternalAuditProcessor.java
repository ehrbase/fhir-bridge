...
public class InternalAuditProcessor implements Processor {

    private final Logger logger = LoggerFactory.getLogger(InternalAuditProcessor.class);

    private final IFhirResourceDao<AuditEvent> auditEventDao;

    public InternalAuditProcessor(IFhirResourceDao<AuditEvent> auditEventDao) {
