...
validate response Bundle - 200
    Integer    response status    200

    String     response body resourceType    Bundle
    String     response body id
    String     response body entry 0 resource meta versionId    1
...
create blood gas panel
    ...
    POST /Bundle with ehr reference  	    ${text}    ${example_json}
...
POST /Bundle with ehr reference
    ...
    ${payload}          Load JSON From File    ${DATA_SET_PATH_BUNDLE}/${example_json}
