...
# all attributes invalid for valueCodeableConcept
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}			  final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       ${EMPTY}	               ${EMPTY}    	        ${EMPTY}		    422          @value cannot be empty                                                                                                                              Observation.value.ofType.CodeableConcept..coding.0..display
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}			  final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true           ${1234}	               test      	        ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.value.x..coding.0..display
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}			  final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       ${EMPTY}	             http://google.com      test   		        422          ele-1: All FHIR elements must have a @value or children                                                                                             Observation.value.ofType.CodeableConcept..coding.0..system
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}			  final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       missing	               ${EMPTY}             missing		        422          @value cannot be empty                                                                                                                              Observation.value.ofType.CodeableConcept..coding.0..code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}			  final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               missing 	            test   		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.value.x..coding.0..system

# all attributes invalid for code
    Observation    	        pregnancy-status  		       true         ${pregnancy_status-url}		      final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   false	  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          Object must have some content                                                                                                                       Observation.code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}		      final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true			  	 ${EMPTY}             	  		  ${EMPTY}        ${EMPTY}                          true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          @value cannot be empty                                                                                                                          	 Observation.code.coding.0..display
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}		      final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true			  	 http://google.com		  		  ${12345}        missing                           true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          The pattern .system http://loinc.org, code 72166-2, and display 'null'. defined in the profile ${pregnancy_status-url}                                Observation.code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}		      final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true			  	 test            		  		  missing         ${12345}                          true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          Coding.system must be an absolute reference, not a local reference                                                                                  Observation.code.coding.0.
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}		      final		     true             true           http://terminology.hl7.org/CodeSystem/observation-category         social-history          true			   true			  	 missing         		  	      test            test1234                          true    		 	valid      		  2020-02-25	      true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          A code with no system has no defined meaning. A system should be provided                                                                           Observation.code.coding.0.

# all attributes invalid for category
#	Observation    	        pregnancy-status  		       true         ${pregnancy_status-url}             final		     true             true           http://google.com                                                  test               true			     true		  		 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422     	 This element does not match any known slice defined in the profile ${pregnancy_status-url}                                  							 Observation.category
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           missing                                                            ${EMPTY}                true			   true			  	 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          @value cannot be empty                                                                                                                              Observation.category.0..coding.0..code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           ${EMPTY}                                                           ${12345}                true			   true			  	 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          @value cannot be empty                                                                                                                              Observation.category.0..coding.0..system
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           ${12345}                                                           missing                 true			   true			     http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.category.0..coding.0..system
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           test                                                               ${EMPTY}                true			   true			  	 http://loinc.org		  		  72166-2         Tobacco pregnancy status            true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA18978-9    	    Never smoker		422          @value cannot be empty                                                                                                                				 Observation.category.0..coding.0..code

# mix invalid attributes
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.value.x..coding.0..display
    ${1234}      	        pregnancy-status  			   true         ${pregnancy_status-url}             final		     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          This does not appear to be a FHIR resource .unknown name '1234'.                                                                                    1234
    Observation    	        ${1234}      				   true         ${pregnancy_status-url}             final		     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.id
    Observation    	        pregnancy-status  			   false        ${pregnancy_status-url}             final		     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  	      ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Coding.system must be an absolute reference, not a local reference                                                                                  Observation.value.ofType.CodeableConcept..coding.0.
    Observation    	        pregnancy-status  			   true         ${1234}                           final		     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Profile reference '1234' could not be resolved, so has not been checked                                                                             Observation.meta.profile.0.
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             ${1234}	     true             true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.status
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     false            true           ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.code.coding.0..system
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             false          ${1234}                                                            ${1234}                 true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Object must have some content                                                                                                                       Observation.category.0.
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 false			   true			  	 ${1234}          		  	      ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Observation.code: minimum required = 1, but only found 0 .from ${pregnancy_status-url}.                                                               Observation
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   false		     ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Expected 1 but found 0 coding elements                                                                                                              Observation.code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   true 			 ${1234}          		  		  ${1234}         ${1234}                           false    	 	    valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Observation.subject: minimum required = 1, but only found 0 .from ${pregnancy_status-url}.                                                            Observation
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   false		     ${1234}          		  		  ${1234}         ${1234}                           true    		 	test      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Expected 1 but found 0 coding elements                                                                                                              Observation.code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   false			 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  ${12345}		      true		    true	       ${1234}	               ${1234}              ${1234}		        422          Not a valid date/time .12345.                                                                                                                       Observation.effective.ofType.dateTime.
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   false			 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  false		    true	       ${1234}	               ${1234}              ${1234}		        422          Expected 1 but found 0 coding elements                                                                                                              Observation.code
    Observation    	        pregnancy-status  			   true         ${pregnancy_status-url}             final  	     true             true           ${1234}                                                            ${1234}                 true			   false			 ${1234}          		  		  ${1234}         ${1234}                           true    		 	valid      		  2020-02-25		  true		    false	       ${1234}	               ${1234}         	    ${1234}		        422          Expected 1 but found 0 coding elements                                                                                                              Observation.code
