...
#|  resourceType   |          		ID   								|           meta         						|                              identifier                         |	  status  	|                         				category                           					        					   |                                        									code          								|         subject                    |	  DateTime	   |  R.-Code  |                                                             diagnostics 							                                              |   location
#|                 |                									|  available  | 			profile  			|  available  |        system         |             value         |             |  available  |  codingavailable  |  				system  									   |    	 code          |  available  |  coding available  |  			0.system	  		|  		0.code	  |    		   0.display 		    |  available  |   Identifier-value   |                 |           |               				                                    ENG				                                                                  |

# all attributes invalid for code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  		       true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://terminology.hl7.org/CodeSystem/observation-category         vital-signs          	true			   false	  		 http://loinc.org		  		  8302-2         Body height           		 	  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          Observation.code.coding.BodyHeightCode. minimum required = 1, but only found 0 .from ${body_height-url}                                                      Observation.code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://terminology.hl7.org/CodeSystem/observation-category         vital-signs          	true			   true			  	 ${EMPTY}             	  		  ${EMPTY}        ${EMPTY}                        true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          @value cannot be empty                                                                                                                          	 Observation.code.coding.0..display
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://terminology.hl7.org/CodeSystem/observation-category         vital-signs          	true			   true			  	 http://google.com		  		  ${12345}        missing                         true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          This element does not match any known slice defined in the profile ${body_height-url}                              Observation.code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://terminology.hl7.org/CodeSystem/observation-category         vital-signs          	true			   true			  	 test            		  		  missing         ${12345}                        true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          Coding.system must be an absolute reference, not a local reference                                                                                  Observation.code.coding.0.
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://terminology.hl7.org/CodeSystem/observation-category         vital-signs          	true			   true			  	 missing         		  	      test            test1234                        true    		 	valid      		  2020-02-25	      true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          A code with no system has no defined meaning. A system should be provided                                                                           Observation.code.coding.0.

# all attributes invalid for category
	Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  		       true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	http://google.com                                                  test                    	true			   true		  		 http://loinc.org		  		  8302-2         Body height            		  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422     	 This element does not match any known slice defined in the profile ${body_height-url}     																										 ${EMPTY}
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	missing                                                            ${EMPTY}                	true			   true			  	 http://loinc.org		  		  8302-2         Body height            		  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          @value cannot be empty                                                                                                                              Observation.category.0..coding.0..code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	${EMPTY}                                                           ${12345}                	true			   true			  	 http://loinc.org		  		  8302-2         Body height            		  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          @value cannot be empty                                                                                                                              Observation.category.0..coding.0..system
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	${12345}                                                           missing                 	true			   true			     http://loinc.org		  		  8302-2         Body height            		  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.category.0..coding.0..system
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${identifiersystem}     ${identifiervalue}           final		     true             true           	test                                                               ${EMPTY}                	true			   true			  	 http://loinc.org		  		  8302-2         Body height            		  true    		 	valid      		  2020-02-25		  true		    true	       http://loinc.org	       LA26683-5    	    Not pregnant		422          @value cannot be empty                                                                                                                				 Observation.category.0..coding.0..code

# mix invalid attributes
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.category.0.
    ${1234}      	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          This does not appear to be a FHIR resource .unknown name '1234'.                                                                                    1234
    ...
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   false        ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  	      ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Coding.system must be an absolute reference, not a local reference                                                                                  Observation.identifier.0.
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${1234}                		  true       ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Profile reference '1234' could not be resolved, so has not been checked                                                                             Observation.meta.profile.0.
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  false      ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.category.0..coding.0..system
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               ${1234}	     true             true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.status
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     false            true           	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                            Observation.code.coding.0..system
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             false          	${1234}                                                            ${1234}                 	true			   true			  	 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Object must have some content                                                                                                                       Observation.category.0.
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	false			   true			  	 ${1234}          		  	      ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                               Observation
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	true			   false		     ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                                              Observation.code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	true			   true 			 ${1234}          		  		  ${1234}         ${1234}                         false    	 	    valid      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Observation.subject: minimum required = 1, but only found 0 .from ${body_height-url}.                                                            Observation
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	true			   false		     ${1234}          		  		  ${1234}         ${1234}                         true    		 	test      		  2020-02-25		  true		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                                              Observation.code
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	true			   false			 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  ${12345}		      true		    true	       ${1234}	               ${1234}              ${1234}		        422          Not a valid date/time .12345.                                                                                                                       Observation.effective.ofType.dateTime.
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}                 	true			   false			 ${1234}          		  		  ${1234}         ${1234}                         true    		 	valid      		  2020-02-25		  false		    true	       ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                                              Observation.code
