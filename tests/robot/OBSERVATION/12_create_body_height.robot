...
010 Create Body Height (Invalid 'DataAbsentReason' AND 'valueCodeableConcept')
	...
	create with DataAbsentReason		  							DataAbsentReason				BodyHeight/create-body-height.json
...
# mix invalid attributes
    ...
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${1234}           			  	  true       ${randinteger}     	 ${randinteger}               final		     true             true           	${1234}                                                            ${1234}              true			   true			  	 ${1234}          		  		  ${1234}         	${1234}                         true    		 	valid      		  2020-02-25		  true		${randstring}	   ${1234}	               ${1234}              ${1234}		        422          Profile reference '1234' has not been checked because it is unknown                                                                                Observation.meta.profile.0.
...
generate payload from example json
	...
	${payload}          Load JSON From File    ${DATA_SET_PATH_OBSERVATION}/BodyHeight/create-body-height.json
...
create body-height JSON
    ...
    &{resp}             Run Keywords
                        ...
                        ...    load JSON                        BodyHeight/create-body-height.json				    AND
