...
# mix invalid attributes
    ...
    Observation    	        23499ea6-d046-4e91-b7ab-d9cf040add72  			   true         ${body_height-url}			  	  true       ${randinteger}     	 ${randinteger}               final  	     true             true           	${1234}                                                            ${1234}              true			   false			 ${1234}          		  		  ${1234}         	${1234}                         true    		 	valid      		  2020-02-25		  false		${randstring}	   ${1234}	               ${1234}              ${1234}		        422          Error parsing JSON: the primitive value must be a string                                                                                           Observation.code
